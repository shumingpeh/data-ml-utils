...
from sm_data_ml_utils.mlflow_databricks.mlflow_tracker import mlflow_log_artifact
from sm_data_ml_utils.mlflow_databricks.mlflow_tracker import mlflow_log_metric
from sm_data_ml_utils.mlflow_databricks.mlflow_tracker import mlflow_log_params
from sm_data_ml_utils.mlflow_databricks.mlflow_tracker import mlflow_log_register_model
...
class TestMlflowTracking:
    ...
    @patch("sm_data_ml_utils.mlflow_databricks.mlflow_tracker.getattr")
